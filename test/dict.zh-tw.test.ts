...
describe('jieba.zh.tw', () => {
  ...
  it('insertUserWord', function () {
    expect(jieba.cut('梅竹錦標對抗賽')).toEqual(['梅竹', '錦標', '對抗賽'])

    jieba.insertUserWord('梅竹錦標對抗賽')
    expect(jieba.cut('梅竹錦標對抗賽')).toEqual(['梅竹錦標對抗賽'])
  })
  ...
  it('lookupTag', function () {
    expect(jieba.lookupTag('摩托車')).toEqual('N')
    expect(jieba.lookupTag('CEO')).toEqual('eng')
    expect(jieba.lookupTag('123')).toEqual('m')
    expect(jieba.lookupTag('。')).toEqual('x')
  })
